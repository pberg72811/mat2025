/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: iccIIR.c
// Desc: This file contains the code for the iccIIR.
// Hist: When       Who  What
...
iccIIRFilterSpec *iccIIRInitBPFLT32(FLT32 fc, FLT32 fs, FLT32 bw )
{
  ...
  FLT64 b2 = -(R*R);
  INT32 ii;
  iccIIRFilterSpec *spec;

  // Malloc the memory for the spec.
  //----------------------------------------------------------------------------
  spec = (iccIIRFilterSpec *) iccMallocVOID_Align032(sizeof(iccIIRFilterSpec));
...
//       created using one of "iccIRRInit" functions.
//------------------------------------------------------------------------------
