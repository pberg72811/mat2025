/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: iccStreamSocketOpen.c
// Desc: This file contains the code for the iccStreamSocketOpen routine.
// Hist: When       Who  What
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR iccStreamSocketOpen: gethostbyname.");
    exit(1);
  }
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR iccStreamSocketOpen:  socket.");
    exit(1);
  }
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR iccStreamSocketOpen:  connect");
    return(0);
  }
