/*----------------------------------------UNCLASSIFIED-----------------------------------------*/
// File: iccXXMLUtils.c                                                                         -
// Desc: This file contains the code for the iccXXMLUtils routine.                              -
// Hist: When       Who  What                                                                   -
...
iccXMLSpec_t * iccXMLInit(const CHR08 *fileName)
{
  ...
  //----------------------------------------------------------------------------
  spec = (iccXMLSpec_t *) iccMallocVOID_Align032(sizeof(iccXMLSpec_t));

  // Allocate memory for the XML message.
  //---------------------------------------------------------------------------------------------
  spec->xmlMessageBuffer  = (CHR08 *) iccMallocINT08_Align032( MAX_XML_MESSAGE_SIZE );
  spec->xmlMessageBuffer2 = (CHR08 *) iccMallocINT08_Align032( MAX_XML_MESSAGE_SIZE );
...
//-----------------------------------------------------------------------------------------------
// Rout: iccXMLTerm
// Desc: This routine terminates the iccXMLSpec.
//-----------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------
  ...
  {                                                //
    iccStringUpper(p);                             // Make sure token is upper case
    //iccStringUpper(tagString);                   // Make sure tag is upper case
...
INT32 xxmlReadFile(const CHR08 *fileName, CHR08 **stringBuffer)
{
  ...
  //---------------------------------------------------------------------------------------------
  *stringBuffer = (CHR08 *) iccMallocINT08_Align032( 1024*1024 );
...
FLT32 xxmlGetContentFLT32(const CHR08 *tagString, CHR08 *xmlMessageBuffer)
{
  ...
  xmlMessageBuffer2 = (CHR08 *) iccMallocINT08_Align032( 1024*1024 );
