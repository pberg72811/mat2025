/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: iccvMean.c
// Desc: This file contains the code for the vectorUtils routine iccvMean.
// Hist: When       Who  What
//       11/14/2001 ptb  Initial Code.
//       08/20/2003 ptb  Added complex code and PERL_PREPROCESS mechanism.
/*----------------------------------------------------------------------------*/
...
PERL_PREPROCESS  }
PERL_PREPROCESS  return(r/((XXXXX)n));
#endif

FLT32 iccvMeanFLT32( FLT32 *a, INT32 i, UNT32 n )
{
...
FLT64 iccvMeanFLT64( FLT64 *a, INT32 i, UNT32 n )
{
...
FLT96 iccvMeanFLT96( FLT96 *a, INT32 i, UNT32 n )
{
...
INT08 iccvMeanINT08( INT08 *a, INT32 i, UNT32 n)
{
...
INT16 iccvMeanINT16( INT16 *a, INT32 i, UNT32 n)
{
...
INT32 iccvMeanINT32( INT32 *a, INT32 i, UNT32 n)
{
...
INT64 iccvMeanINT64( INT64 *a, INT32 i, UNT32 n)
{
...
UNT08 iccvMeanUNT08( UNT08 *a, INT32 i, UNT32 n)
{
...
UNT16 iccvMeanUNT16( UNT16 *a, INT32 i, UNT32 n)
{
...
UNT32 iccvMeanUNT32( UNT32 *a, INT32 i, UNT32 n)
{
...
UNT64 iccvMeanUNT64( UNT64 *a, INT32 i, UNT32 n)
{
...
CFLT32 iccvMeanCFLT32( CFLT32 *a, INT32 i, UNT32 n )
{
...
CFLT64 iccvMeanCFLT64( CFLT64 *a, INT32 i, UNT32 n )
{
...
CFLT96 iccvMeanCFLT96( CFLT96 *a, INT32 i, UNT32 n )
{
...
CINT08 iccvMeanCINT08( CINT08 *a, INT32 i, UNT32 n)
{
...
CINT16 iccvMeanCINT16( CINT16 *a, INT32 i, UNT32 n)
{
...
CINT32 iccvMeanCINT32( CINT32 *a, INT32 i, UNT32 n)
{
...
CINT64 iccvMeanCINT64( CINT64 *a, INT32 i, UNT32 n)
{
...
CUNT08 iccvMeanCUNT08( CUNT08 *a, INT32 i, UNT32 n)
{
...
CUNT16 iccvMeanCUNT16( CUNT16 *a, INT32 i, UNT32 n)
{
...
CUNT32 iccvMeanCUNT32( CUNT32 *a, INT32 i, UNT32 n)
{
...
CUNT64 iccvMeanCUNT64( CUNT64 *a, INT32 i, UNT32 n)
{
