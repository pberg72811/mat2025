/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: iccvSinT.c
// Desc: This file contains the code for the vectorUtils routine iccvSinT a
//       table drive sine function.
// Hist: When       Who  What
...
/* Constants -----------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
#define sineTableSize    1024
#define sineTableSizeFLT 1024.0
#define oneOverTWOPI     0.159154943091895
FLT32 iccSineTable[sineTableSize] = {
...
/* Macros --------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
#define COMMON_CODE register UNT32 k;   \
                    register INT32 tmp; \
                    pa = a;    \
                    pb = b;    \
                    for(k=0; k<n; k++){                           \
                      tmp = sineTableSizeFLT * (*pa*oneOverTWOPI);\
                      *pb = iccSineTable[tmp%1024];               \
                       pa += i;                                   \
                       pb += j;}                                  \
...
/* Routines ------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
void iccvSinTFLT32( FLT32 *a, INT32 i, FLT32 *b, INT32 j, UNT32 n )
{
  FLT32   *pa;
  FLT32   *pb;
  COMMON_CODE
...
void iccvSinTFLT64( FLT64 *a, INT32 i, FLT64 *b, INT32 j, UNT32 n )
{
  FLT64 *pa;
  FLT64 *pb;
  COMMON_CODE
...
void iccvSinTFLT96( FLT96 *a, INT32 i, FLT96 *b, INT32 j, UNT32 n )
{
  FLT96 *pa;
  FLT96 *pb;
  COMMON_CODE
