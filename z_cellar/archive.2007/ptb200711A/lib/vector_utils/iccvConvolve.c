/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: iccvConvolve.c
// Desc: This file contains the code for the vectorUtils routine iccvConvolve.
// Hist: When       Who  What
...
/* Routines ------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
FLT32 iccvConvolveFLT32( FLT32 *a, INT32 i, FLT32 *b, INT32 j, UNT32 n )
{
...
FLT64 iccvConvolveFLT64( FLT64 *a, INT32 i, FLT64 *b, INT32 j, UNT32 n )
{
...
FLT96 iccvConvolveFLT96( FLT96 *a, INT32 i, FLT96 *b, INT32 j, UNT32 n )
{
...
INT08 iccvConvolveINT08( INT08 *a, INT32 i, INT08 *b, INT32 j, UNT32 n)
{
...
INT16 iccvConvolveINT16( INT16 *a, INT32 i, INT16 *b, INT32 j, UNT32 n)
{
...
INT32 iccvConvolveINT32( INT32 *a, INT32 i, INT32 *b, INT32 j, UNT32 n)
{
...
INT64 iccvConvolveINT64( INT64 *a, INT32 i, INT64 *b, INT32 j, UNT32 n)
{
...
UNT08 iccvConvolveUNT08( UNT08 *a, INT32 i, UNT08 *b, INT32 j, UNT32 n)
{
...
UNT16 iccvConvolveUNT16( UNT16 *a, INT32 i, UNT16 *b, INT32 j, UNT32 n)
{
...
UNT32 iccvConvolveUNT32( UNT32 *a, INT32 i, UNT32 *b, INT32 j, UNT32 n)
{
...
UNT64 iccvConvolveUNT64( UNT64 *a, INT32 i, UNT64 *b, INT32 j, UNT32 n)
{
...
FLT32 iccvConvolveFLT32FLT64( FLT32 *a, INT32 i, FLT64 *b, INT32 j, UNT32 n )
{
  FLT32 *pa=a+(n*i);
  FLT64 *pb=b;
  FLT32 r = 0.0;
