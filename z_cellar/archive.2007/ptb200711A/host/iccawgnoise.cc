...
// Examples:                                                                                    -
// pipe on                                                                                      -
// iccawgnoise/continuous _stream(ps=32M) si 10e6 3000 8.5e6                                    -
// iccarchive _stream awgtest 1024*1024*1024 /data11/steswd/ 10                                 -
// pipe off                                                                                     -
//01.0 Description                                                                              -
//02.0 Requirements                                                                             -
//03.0 Interfaces                                                                               -
...
VOID mainroutine()
{
  ...
  if     ( oHeader.format == "SB" ) {
    complexFlag   = 1;
    if(uniformFlag) generic_noise = iccvRandINT08;
    else            generic_noise = iccvRandNINT08;
  }
  else if( oHeader.format == "SI" ) {
    complexFlag   = 1;
    if(uniformFlag) generic_noise = iccvRandINT16;
    else            generic_noise = iccvRandNINT16;
  }
  else if( oHeader.format == "SL" ) {
    complexFlag   = 1;
    if(uniformFlag) generic_noise = iccvRandINT32;
    else            generic_noise = iccvRandNINT32;
  }
  else if( oHeader.format == "SF" ) {
    complexFlag   = 1;
    if(uniformFlag) generic_noise = iccvRandFLT32;
    else            generic_noise = iccvRandNFLT32;
  }
  else if( oHeader.format == "SD" ) {
    complexFlag   = 1;
    if(uniformFlag) generic_noise = iccvRandFLT64;
    else            generic_noise = iccvRandNFLT64;
  }
  ...
  //---------------------------------------------------------------------------------------------
  XMC_DEBUG("Initialize iccawgnoise.\n");
