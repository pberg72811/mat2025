...
//                          V                                                                   -
//    :---------:     :------------:     :---------:                                            -
//    |FILE/PIPE|---> |iccendian.cc|---> |FILE/PIPE|                                            -
//    :---------:     :------------:     :---------:                                            -
//                          |                                                                   -
//                          V                                                                   -
//                    Debug Statements                                                          -
...
VOID mainroutine()
{
  ...
  {
    genericEndian = iccvSwapEndianINT16;
    complexFlag=1;
  }
  else if( strncmp(&iHeader.format.buf[0], "SL", 2)==0 )
  {
    genericEndian = iccvSwapEndianINT32;
    complexFlag=1;
  }
  ...
  {
    genericEndian = iccvSwapEndianINT64;
    complexFlag=1;
  }
  ...
  oDataINT08  = iccMallocINT08_Align032 ( xferLngth ); // Generic output not just INT08.
