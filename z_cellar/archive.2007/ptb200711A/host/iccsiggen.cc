...
//                             V                                                                -
//    :-----------:     :--------------:     :-----------:                                      -
//    | FILE/PIPE |---> | iccsiggen.cc |---> | FILE/PIPE |                                      -
//    :-----------:     :--------------:     :-----------:                                      -
//                             |                                                                -
//                             V                                                                -
//                      Debug Statements                                                        -
...
VOID mainroutine()
{
  ...
  VOID (*iccGenericSigGen)(VOID *, INT32, INT32, iccSigGenSpecFLT64 *);
  ...
  //---------------------------------------------------------------------------------------------
  sigSpec = iccSigGenInitFLT64(fc, fs, amp, phs);
  
  // Allocate data buffer for signals.
  //---------------------------------------------------------------------------------------------
  oDataINT08 = (INT08 *) iccMallocINT08_Align032(xferLngth);
  ...
  {
    iccGenericSigGen(oDataINT08, 1, xferSamps, sigSpec );
