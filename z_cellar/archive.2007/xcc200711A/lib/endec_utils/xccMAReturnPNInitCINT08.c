...
CINT08 *xccMAReturnPNInit( UNT16 shiftRegisterA, UNT16 shiftRegisterC )
{
...
//------------------------------------------------------------------------------
  pnCINT08 = (CINT08 *) malloc(sizeof(CINT08)*MA_PN_LENGTH);
...
//------------------------------------------------------------------------------
    pnCINT08[ii].r = (shiftRegisterAResult + shiftRegisterBResult)%2;
    pnCINT08[ii].i = (shiftRegisterCResult + shiftRegisterBResult)%2;
