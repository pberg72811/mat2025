/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccStreamSocketListen.c
// Desc: This file contains the code for the xccStreamSocketListen routine.
// Hist: When       Who  What
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR xccStremSocketListen:  socket.");
    exit(1);
  }
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR xccStremSocketListen:  setsocketopt.");
    exit(1);
  }
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR xccStremSocketListen: bind.");
    exit(1);
  }
...
//------------------------------------------------------------------------------
  ...
  {
    perror("ERROR xccStremSocketListen:  listen");
    exit(1);
  }
