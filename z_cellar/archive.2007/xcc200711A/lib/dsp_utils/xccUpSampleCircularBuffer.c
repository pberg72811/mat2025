/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccUpSampleCircularBuffer.c
// Desc: This file contains the code for the xccUpSampleCircularBuffer.
// Hist: When       Who  What
...
{
  xccUpSampleSpecFLT64 *spec;

  // Malloc the memory for the spec.
  //----------------------------------------------------------------------------
  spec = (xccUpSampleSpecFLT64 *) xccMallocINT08_Align032(sizeof(xccUpSampleSpecFLT64));
...
//------------------------------------------------------------------------------
// Rout: xccUpSampleCircularBufferXXXXX
