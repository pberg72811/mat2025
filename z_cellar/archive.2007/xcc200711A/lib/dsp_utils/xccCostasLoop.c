/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccCostasLoop.c
// Desc: This file contains the code for the xccCostasLoop.
// Hist: When       Who  What
...
{
  xccCostasLoopSpec *spec;

  // Malloc the memory for the spec.
  //----------------------------------------------------------------------------
  spec = (xccCostasLoopSpec *) xccMallocVOID_Align032(sizeof(xccCostasLoopSpec));
