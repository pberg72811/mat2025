/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccLoopFilter.c
// Desc: This file contains the code for the xccLoopFilter.
// Hist: When       Who  What
...
xccLoopFilterSpec *xccLoopFilterInit(FLT64 lockInRange,
				     ...
				     FLT64 fs)
{
  xccLoopFilterSpec *spec;

  // Malloc the memory for the spec.
  //----------------------------------------------------------------------------
  spec = (xccLoopFilterSpec *) xccMallocVOID_Align032(sizeof(xccLoopFilterSpec));
