/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccSHMUtils.c
// Desc: This file contains the code for the xccSHMUtils routine.
// Hist: When       Who  What
			...
			INT32 bpe)
{
  ...
  //----------------------------------------------------------------------------
  spec = (xccSHMSpec *) xccMallocVOID_Align032( sizeof(xccSHMSpec) );
...
VOID xccSHMWrite(INT08 *iData, UNT32 nSamples, xccSHMSpec *spec)
{
  UNT32 ii;
  INT08 *pa=iData;
  UNT32 shmDifference;
