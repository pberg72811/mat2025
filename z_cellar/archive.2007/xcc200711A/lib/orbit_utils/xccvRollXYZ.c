/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccvRollXYZ.c
// Desc: This file contains the code for the xccOribitUtils routine xccvRollXYZ.
// Hist: When       Who  What
...
PERL_PREPROCESS  FLT64 rollXform[9]  = { +1.0       , +0.0       , +0.0       ,
PERL_PREPROCESS                          +0.0       , +cos(roll ), +sin(roll ),
PERL_PREPROCESS                          +0.0       , -sin(roll ), +cos(roll )};
PERL_PREPROCESS
...
PERL_PREPROCESS
PERL_PREPROCESS    xccMatrixCompositeFLT64( rollXform, 1, 3, 3,
...
//------------------------------- COMMON-CODE FLT32      START.
  ...
  for(kk=0; kk < n; kk++)
  {
    ...
    xccMatrixCompositeFLT64( rollXform, 1, 3, 3,
                             &tempA.x,  1, 3, 1,
                             &tempB.x,  1, 3, 1);
