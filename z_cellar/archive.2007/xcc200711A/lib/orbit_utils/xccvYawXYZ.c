/*-------------------------------UNCLASSIFIED---------------------------------*/
// File: xccvYawXYZ.c
// Desc: This file contains the code for the xccOribitUtils routine xccvYawXYZ.
// Hist: When       Who  What
...
PERL_PREPROCESS  FLT64 yawXform[9]   = { +cos(yaw  ), +sin(yaw  ), +0.0       ,
PERL_PREPROCESS                          -sin(yaw  ), +cos(yaw  ), +0.0       ,
PERL_PREPROCESS                          +0.0       , +0.0       , +1.0       };
PERL_PREPROCESS
...
PERL_PREPROCESS
PERL_PREPROCESS    xccMatrixCompositeFLT64( yawXform, 1, 3, 3,
...
//------------------------------- COMMON-CODE FLT32      START.
  ...
  for(kk=0; kk < n; kk++)
  {
    ...
    xccMatrixCompositeFLT64( yawXform, 1, 3, 3,
                             &tempA.x, 1, 3, 1,
                             &tempB.x, 1, 3, 1);
