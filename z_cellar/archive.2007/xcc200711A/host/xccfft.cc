...
// File: xccfft.cc                                                                              -
//                                                                                              -
// Desc: This primitive performs a Fast Fourier Transform on the input data.                    -
//                                                                                              -
// Args: iFileName  - The name of the input file.                                               -
//       oFileName  - The name of the output file.                                              -
//       fftSize    - The size of the fft to perform.                                           -
//                                                                                              -
// Swch: None.                                                                                  -
//                                                                                              -
// Hist: When       Who  What                                                                   -
...
VOID mainroutine()
{
  ...
  oDataCFLT32 = xccMallocCFLT32_Align032( xferSamps );
  magFLT32    = xccMallocFLT32_Align032( xferSamps );
  ...
  while( (nGot==xferSamps) && (!Mc->break_) )
  {
    ...
    // Calculate magnitude square.
    //-------------------------------------------------------------------------------------------
    for(ii=0; ii< xferSamps; ii++)
    {
