...
//                            V                                                                 -
//    :-----------:     :-----------:     :---------------:                                     -
//    | FILE/PIPE |---> | xccpll.cc |---> | VCO FILE/PIPE |                                     -
//    :-----------:     :-----------: |   :---------------:-:                                   -
//                            |       +---> | ERR FILE/PIPE |                                   -
//                            |       |     :---------------:-:                                 -
//                            |       +-----> | DRO FILE/PIPE |                                 -
...
VOID mainroutine()
{
  ...
  {
    genericToCFLT64 = xccvCINT64ToCFLT64;
  }
  ...
  oDroCFLT32  = xccMallocCFLT32_Align032( xferSamps );
  ...
  while( (nGot==xferSamps) && (!Mc->break_) )
  {
	...
	lpfError = xccLoopFilterFLT64( phaseDif, lpfSpec );  // Run phase through the loop filter.
