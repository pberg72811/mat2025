...
//                               V                                                              -
//    :-----------:     :-------------------:     :-----------:                                 -
//    | FILE/PIPE |---> | xccphasedetect.cc |---> | FILE/PIPE |                                 -
//    :-----------:     :-------------------:     :-----------:                                 -
//                               |                                                              -
//                               V                                                              -
//                        Debug Statements                                                      -
...
VOID mainroutine()
{
  ...
  signalCFLT64 = xccMallocCFLT64_Align032( xferSamps );
  tempCFLT64   = xccMallocCFLT64_Align032( xferSamps );

  signalSpec = xccSigGenInitFLT64(refFreq, fs, 1.0, 0.04);
  xccSigGenCosSinCFLT64(signalCFLT64, 1, xferSamps, signalSpec );
  ...
  while( (nGot==xferSamps) && (!Mc->break_) )
  {
    ...
    xccvsSubCFLT64(inDataCFLT64, 1, meanValueCFLT64, inDataCFLT64, 1, xferSamps);

    // Multiply and sum with sin and cos.
    //-------------------------------------------------------------------------------
    //xccvMulCFLT64(signalCFLT64, 1, inDataCFLT64, 1,  tempCFLT64, 1, xferSamps);
    xCFLT64 = xccvMulSumCFLT64(signalCFLT64, 1, inDataCFLT64, 1,  xferSamps);
