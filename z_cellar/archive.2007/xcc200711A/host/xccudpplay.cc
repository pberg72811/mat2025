...
//                          V                                                                   -
//    :---------:     :-------------:     :--------:                                            -
//    |FILE/PIPE|---> |xccudpplay.cc|---> |NIC CARD|                                            -
//    :---------:     :-------------:     :--------:                                            -
//                          |                                                                   -
//                          V                                                                   -
//                    Debug Statements                                                          -
...
VOID mainroutine()
{
  ...
  //  else                                        // Else                                       -
  //  {                                           //                                            -
  //    xferLngth = XCC_MAX_MSG_LEN;              // Default to XCC_MAX_MSG_LEN bytes.          -
  //    xferSamps = xferLngth/iHeader.bpe;        // Calculate transfer samples.                -
  //  }                                           //---------------------------------------------
  ...
  //---------------------------------------------------------------------------------------------
  datagramSpec = xccDatagramSocketSendInit(ipAddress.c_str(), thePort);
  ...
  while( (nGot==xferSamps) && !Mc->break_ )
  {
    ...
    // Send the packets.
    //-------------------------------------------------------------------------------------------
    nBytes = xccDatagramSocketSend(iDataINT08, nGot*iHeader.bpe, datagramSpec);
