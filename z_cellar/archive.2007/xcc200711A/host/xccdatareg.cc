...
//                             V                                                                -
//    :-----------:     :---------------:     :-----------:                                     -
//    | FILE/PIPE |---> | xccdatareg.cc |---> | FILE/PIPE |                                     -
//    :-----------:     :---------------:     :-----------:                                     -
//                             |                                                                -
//                             V                                                                -
//                      Debug Statements                                                        -
...
VOID mainroutine()
{
  ...
  pDataINT08 = xccMallocINT08_Align032(xferLngth);
  zDataINT08 = xccMallocINT08_Align032(xferLngth);
  xccvZeroINT08( iDataINT08, 1, xferLngth );
  xccvZeroINT08( pDataINT08, 1, xferLngth );
  xccvZeroINT08( zDataINT08, 1, xferLngth );
  ...
  while((nGot==xferSamps) && !Mc->break_)
  {
    ...
    //-------------------------------------------------------------------------------------------
    xccvCopyINT08(iDataINT08, 1, pDataINT08, 1, nGot*iHeader.bpe);
