classdef whogi < matlab.task.LiveTask
    ...
    methods
        ...
        function reset(task)
            task.Slider.Value = 16;
            task.SliderHelper.Value = 16;
            task.Slider1.Value = 3;
            task.Slider1Helper.Value = 3;
        end
    end
